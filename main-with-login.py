...
# You can edit these
# BEGIN_PAG and END_PAG to change where program begins and ends (https://www.mangaupdates.com/releases.html)
# username and password are needed to show eromanga related covers because MU doesn't display them if you're not logged in, if you don't want to login use the other .py file
BEGIN_PAG = 1
END_PAG = 15
username = 'usr'
password = 'pwd'
